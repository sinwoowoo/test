<template>
	<div class="page-contents">
	  <div class="container">
	    ...
	    <div class="page-title">
	      ...
	      <ul>
			...
			<li>kt그룹서비스</li>
			<li><router-link to="/service/ktservice" @click="pushParam(1)">B. 인터넷 서비스</router-link></li>
			<li><router-link to="/service/ipservice_infra">인터넷 서비스 인프라</router-link></li>
		  </ul>
	    </div>
	    
	    <div class="page-tab">
	      <div class="current-label">
	        <a href="">인터넷 서비스 인프라</a>
	      </div>
	      <ul>
	        <li><router-link to="/service/ipservice_internet">인터넷 서비스 </router-link></li>
			<li class="active"><router-link to="/service/ipservice_infra">인터넷 서비스 인프라</router-link></li>   
	      </ul>
	    </div>
	    ...
	    <div class="row">
	      <div class="col s12">
	        <div class="center-align">
	        	<img src="@/assets/images/img_infra2.gif" alt="tset" class="responsive-img" />
	        </div>
	      </div>
	      <div class="col s12">
	        <div class="center-align">
	        	<img src="@/assets/images/img_infra3.gif" alt="tset" class="responsive-img" />
	        </div>
	      </div>
	    </div>
	  ...
	  <div class="container security_system display:none">
	  	<div class="row">
	      <div class="col s12">
	        <div class="center-align">
	        	<img src="@/assets/images/img_infra5_2.gif" alt="tset" class="responsive-img" />
	        </div>
	      </div>
	      <div class="col s12">
	  ...
	  <div class="container ipv6_provide display:none">
	  	<div class="row">
	      <div class="col s12">
	        <div class="center-align">
	        	<img src="@/assets/images/img_infra6_2.gif" alt="tset" class="responsive-img" />
	        </div>
	      </div>
	      <div class="col s12">
	        <ul class="list-style1">
