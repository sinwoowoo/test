	...
	<div class="page-contents">
		<div class="container">		
			...
			<div class="page-tab">
				...
				<li class="active"><router-link to="/service/iot_service">IoT 서비스</router-link></li>   
		...
		<div class="container service_info">
			<div class="row">
				<div class="col s12">
					...
					<ul class="list-style1">						
						<ul>
							<li><b>사물인터넷 서비스 정의</b> - 정보통신기술 기반으로 모든 사물을 연결해 사물-네트워크
							서비스플랫폼 간 정보를 교류하고 소통하는 지능형 인프라 및 서비스</li>
						</ul>
						<ul>
							<li><b>정부사물인터넷 서비스, G-IoT</b> - 정부는 공공(대만서비스 혁신), 산업(생산성·효율성 및
						...
						<div class="left-align">
							<img src="@/assets/images/img_IoT_service_new.png" alt="tset" class="responsive-img2" />
						</div>
						<ul>
							<li><b>정부사물인터넷 공통기반 구축 목적</b> - 로밍 등을 통한 지역한계 극복 및 공통기반을 활용한 
							빠른 서비스 구현과 타기관·상용서비스 연계·협업을 통한 융·복합 서비스 가능한 기반 제공</li>
							<li><b>사물인터넷 서비스 이용제도의 역할</b> - 지자체 등 행정기관에서 구축한 다양한 통신
